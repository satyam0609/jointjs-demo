...
//                 tagName: "circle",
//                 selector: "button",
//                 attributes: { r: 8, fill: "#ef4444", cursor: "pointer" },
//               },
//               {
//                 tagName: "text",
//                 selector: "icon",
...
//   //           source: { id: view.model.id, anchor: { name: "center" } },
//   //           target: { x: 0, y: 0, anchor: { name: "center" } }, // dummy
//   //           attrs: {
//   //             line: {
//   //               stroke: "#374151",
//   //               strokeWidth: 2,
...
//   //         // ---------------- POINTER MOVE (follow cursor + highlight target) ----------------
//   //         const pointerMoveHandler = (moveEvt: PointerEvent) => {
...
//   //           linkInProgressRef.current.target({ x: local.x, y: local.y });

//   //           // Highlight potential target
//   //           const viewsAtPoint = paper.findViewsFromPoint(local);
//   //           let targetElement: joint.dia.ElementView | null = null;

//   //           for (const v of viewsAtPoint) {
//   //             if (v.model.isElement && v.model.id !== view.model.id) {
//   //               targetElement = v;
//   //               break;
//   //             }
//   //           }
...
//   //           if (lastHighlightedView && lastHighlightedView !== targetElement) {
//   //             joint.highlighters.mask.remove(
//   //               lastHighlightedView,
//   //               "targetHighlight"
//   //             );
...
//   //           if (targetElement && targetElement !== lastHighlightedView) {
...
//   //               }
//   //             );
//   //             lastHighlightedView = targetElement;
//   //           }
//   //         };

//   //         // ---------------- POINTER UP (attach link or remove) ----------------
//   //         const pointerUpHandler = (upEvt: PointerEvent) => {
//   //           if (!linkInProgressRef.current) return;
...
//   //           const viewsAtPoint = paper.findViewsFromPoint(local);
//   //           let targetElement: joint.dia.Element | null = null;

//   //           for (const v of viewsAtPoint) {
//   //             if (v.model.isElement && v.model.id !== view.model.id) {
//   //               targetElement = v.model;
//   //               break;
//   //             }
//   //           }
...
//   //   ): string {
//   //     // Get bbox from model if el is a view, or use el directly if it is a model
...
//   //     // Reference point: center of the other element
...
//   //     return bestAnchor; // return string name
//   //   }
...
//   //         // Create a link starting from the source element
//   //         const link = new joint.shapes.standard.Link({
//   //           source: { id: view.model.id, anchor: { name: "center" } },
//   //           target: { x: 0, y: 0, anchor: { name: "center" } }, // dummy
//   //           attrs: {
...
//   //               stroke: "#374151",
//   //               strokeWidth: 2,
//   //               targetMarker: { type: "classic", fill: "#374151" }, // arrow
//   //             },
//   //           },
//   //           router: { name: "orthogonal" },
//   //           connector: { name: "rounded" },
...
//   //         link.label(0, {
//   //           attrs: {
//   //             text: { text: "My Link", fill: "#000", fontSize: 14 },
//   //             rect: {
//   //               fill: "#fff",
//   //               stroke: "#ccc",
//   //               strokeWidth: 0.5,
...
//   //           if (targetElement) {
//   //             if (targetElement.id === view.model.id) {
//   //               // Self-link: create visible loop above the element
//   //               linkInProgressRef.current.target({
//   //                 id: targetElement.id,
//   //                 anchor: { name: "top" }, // start from top
//   //               });

//   //               // Use a custom vertices to create loop
//   //               const bbox = view.model.getBBox();
//   //               linkInProgressRef.current.vertices([
//   //                 { x: bbox.x + bbox.width / 2, y: bbox.y - 70 }, // top-right
//   //                 { x: bbox.x + bbox.width / 2 - 50, y: bbox.y - 70 }, // top-left
//   //               ]);

//   //               // Connector remains rounded
//   //               linkInProgressRef.current.connector({ name: "rounded" });
//   //               linkInProgressRef.current.router({ name: "orthogonal" });
//   //             } else {
//   //               // Normal link
//   //               const targetAnchorName = autoAnchorName(
//   //                 targetElement,
//   //                 view.model.getBBox()
//   //               );
//   //               const sourceAnchorName = autoAnchorName(
//   //                 view.model,
//   //                 targetElement.getBBox()
//   //               );
//   //               linkInProgressRef.current.target({
//   //                 id: targetElement.id,
...
export default function DaigramBuilder() {
  ...
  useEffect(() => {
    ...
    paper.on("link:mouseleave", (linkView: joint.dia.LinkView) => {
    ...
    // Double-click to edit element label
    paperInstanceRef.current.on("element:pointerdblclick", (cellView: any) => {
      const currentText = cellView.model.attr("label/text");
      const newText = prompt("Edit label:", currentText);
      if (newText !== null) {
    ...
    // Double-click to edit link label
    paperInstanceRef.current.on("link:pointerdblclick", (linkView: any) => {
      const link = linkView.model as joint.dia.Link;
      const currentText = link.label(0)?.attrs?.text?.text || "";
